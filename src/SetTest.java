...
public abstract class SetTest {
    ...
    @Test
    public void addDuplicatesDoesNotIncreaseSize() {    // Se till att detta är gjort i HashSet.java
        // Arrange
    ...
    public void removeElementsDoesNotDecrementSizeWhenSetIsEmpty() {     //
        ...
        int expectedSize = 0;
        // Try to remove elements that are not in the set - expected size: 0. (elementsNotInSet or uniqueSetElements) both work fine here.
        for (int elem : uniqueSetElements) {
    ...
    public void removeIsFalseWhenElementIsNotInSet() {  //
        // Arrange
        Arrays
                // We want to add elements to Arrays that are not in set, thus the removal process will fail.
